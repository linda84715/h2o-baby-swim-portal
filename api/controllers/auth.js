...
export const register = (req, res) => {
  ...
  db.query(q, [req.body.email, req.body.username], (err, data) => {
    ...
    const q = "INSERT INTO users(`username`, `email`, `password`, `firstName`, `lastName`, `points`) VALUES (?)";
    const values = [req.body.username, req.body.email, hash, req.body.firstName, req.body.lastName, req.body.points];
